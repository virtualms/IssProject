...
//Prepare to acquire answer to request
	...
	override fun forward(  msg: ApplMessage, destination: String){
 		publish(msg.toString(), "unibo/qak/" + destination)		
	}
	
	override fun request(  msg: ApplMessage, destination: String){
 		publish(msg.toString(), "unibo/qak/"+ destination)
		//The answer should be in unibo/qak/clientmqtt		
	}
	
	override fun emit( msg: ApplMessage, destination: String ){
 		publish(msg.toString(), "unibo/" + destination)		
	}	
}
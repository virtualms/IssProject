	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					...
					transition(edgeName="t133",targetState="endwork",cond=whenDispatch("end"))
				}	 
				...
				state("doStep") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t034",targetState="stepPerhapsDone",cond=whenTimeout("local_tout_basicrobot_doStep"))   
					transition(edgeName="t035",targetState="stepFail",cond=whenEvent("obstacle"))
				}	 
				state("stepPerhapsDone") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t036",targetState="stepDone",cond=whenTimeout("local_tout_basicrobot_stepPerhapsDone"))   
					transition(edgeName="t037",targetState="stepFailDetected",cond=whenEvent("obstacle"))
				}	 

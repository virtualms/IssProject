...
//   				 else -> //println("WARNING: protocol unknown")
	...
	fun showSystemInfo(){
      ...
      abstract fun forward( msg : ApplMessage, destination: String )
      abstract fun request( msg : ApplMessage , destination: String)
      abstract fun emit( msg : ApplMessage, destination: String )

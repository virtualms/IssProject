		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t153",targetState="execcmd",cond=whenDispatch("cmd"))
					transition(edgeName="t154",targetState="doStep",cond=whenRequest("step"))
					transition(edgeName="t155",targetState="endwork",cond=whenDispatch("end"))
				}	 
				...
				state("doStep") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t056",targetState="stepPerhapsDone",cond=whenTimeout("local_tout_basicrobot_doStep"))   
					transition(edgeName="t057",targetState="stepFail",cond=whenEvent("obstacle"))
				}	 
				state("stepPerhapsDone") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t058",targetState="stepDone",cond=whenTimeout("local_tout_basicrobot_stepPerhapsDone"))   
					transition(edgeName="t059",targetState="stepFailDetected",cond=whenEvent("obstacle"))
				}	 

		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t040",targetState="moveToEntrance",cond=whenRequest("moveToEntrance"))
					transition(edgeName="t041",targetState="moveToTable",cond=whenRequest("moveToTable"))
					transition(edgeName="t042",targetState="moveToBarman",cond=whenRequest("moveToBarman"))
					transition(edgeName="t043",targetState="moveToExit",cond=whenRequest("moveToExit"))
					transition(edgeName="t044",targetState="moveToHome",cond=whenRequest("moveToHome"))
				}	 
				state("moveToEntrance") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t045",targetState="respondEntrance",cond=whenReply("atcell"))
				}	 
				...
				state("moveToTable") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t046",targetState="respondTeaTable",cond=whenReply("atcell"))
				}	 
				...
				state("moveToBarman") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t047",targetState="respondBarman",cond=whenReply("atcell"))
				}	 
				...
				state("moveToExit") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t048",targetState="respondExit",cond=whenReply("atcell"))
				}	 
				...
				state("moveToHome") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t049",targetState="respondHome",cond=whenReply("atcell"))
				}	 

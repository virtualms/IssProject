		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t05",targetState="timer",cond=whenDispatch("startTimer"))
				}	 
				state("timer") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t06",targetState="timeover",cond=whenTimeout("local_tout_timer1_timer"))   
					transition(edgeName="t07",targetState="wait",cond=whenDispatch("stopTime"))
				}	 
